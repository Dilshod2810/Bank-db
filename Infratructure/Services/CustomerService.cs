...
public class CustomerService(IContext context) : IGenericService<Customer>, ICustomerService
{
    ...
    {
        using var connection = context.Connection();
        string sql = "select count(firstname) from customers where firstname='John';";
